<h1 align="center">Email Sender, v1.4</h1>
<h4 align="center">Email Sender - Email Sender - это простая программа, позволяющая отправлять электронной почту без необходимости открывать web-версию или запускать отдельный клиент.</h4>
...
- Начиная с **v1.4** нарушена совместимость с предыдущими версиями **Email Sender**. 
